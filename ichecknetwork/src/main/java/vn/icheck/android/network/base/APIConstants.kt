...
//            return if (BuildConfig.FLAVOR.contentEquals("dev")) "https://api.dev.icheck.vn/api/business/" else "https://api.icheck.com.vn/api/business/"
    ...
    object Campaign {
        ...
        const val DETAIL_CAMPAIGN = "user/loyalty/campaign/{id}/info"
        const val DETAIL_CAMPAIGN_V2 = "loyalty/campaign/{id}/info"
        const val LIST_REWARD = "user/loyalty/campaign/{id}/reward"
        const val LIST_USER_REWARD = "user/loyalty/campaign/{id}/user-has-reward"
        const val JOIN_CAMPAIGN = "user/loyalty/campaign"
        const val LIST_BOX_REWARD = "user/loyalty/reward/box"
        const val LIST_ITEM_REWARD = "user/loyalty/reward/item"
        const val DETAIL_ITEM_GIFT = "user/loyalty/reward/item/{id}"
        const val UNBOX_GIFT = "user/loyalty/reward/box/open"
        ...
        const val ACCEPT_GIFT = "user/loyalty/reward/item/ship"
        const val ACCEPT_DA_LAY_QUA = "user/loyalty/reward/order"
        ...
        const val GET_CAMPAIGN_REWARD_iCOIN = "loyalty/campaign/{id}/reward/coin"
    ...
    object GiftStore {
        ...
        const val ACCEPT_EXCHANGE_GIFT_STORE = "gift-exchange/exchange"
