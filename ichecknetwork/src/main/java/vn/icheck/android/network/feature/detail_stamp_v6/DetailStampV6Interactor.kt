...
class DetailStampV6Interactor : BaseInteractor() {

    fun onGetDataStampQRMV6(code: String, mId: String?, listener: ICApiListener<ICDetailStampV6>) {
        ...
        val disposable = ICNetworkClient.getStampClientV6().getDetailStampQRMV6(body)
    ...
    fun onGetDataStampQRIV6(code: String,mId: String?, listener: ICApiListener<ICDetailStampV6>){
        val body = hashMapOf<String, Any>()
        body["code"] = code
        if (mId != null) {
            body["icheck_id"] = mId
        ...
        val disposable = ICNetworkClient.getStampClientV6().getDetailStampQRIV6(body)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        {
    ...
    fun getHistoryGuaranteeV6(qrm:String,listener:ICApiListener<ICListHistoryGuaranteeV6>){
    ...
    fun onUpdateInformationStampV6(district: String, city: String, name: String, email: String, mIdStamp: String, mIdStore: Int, address: String, phone: String, devideId: String, listener: ICApiListener<IC_RESP_UpdateCustomerGuaranteeV6>) {
        val body = hashMapOf<String, Any>()
