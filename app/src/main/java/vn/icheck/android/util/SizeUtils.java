...
public final class SizeUtils {
    ...
    /**
     * Force get the size of listener.
     * <p>e.g.</p>
     * <pre>
     * SizeUtils.forceGetViewSize(listener, new SizeUtils.onGetSizeListener() {
     *     Override
     *     public void onGetSize(final View listener) {
     *         listener.getWidth();
     *     }
     * });
     * </pre>
    ...
    /**
     * Measure the listener.
     *
     * @param view The listener.
     * @return arr[0]: listener's width, arr[1]: listener's height
     */
