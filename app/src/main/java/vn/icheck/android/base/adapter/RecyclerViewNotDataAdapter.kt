...
abstract class RecyclerViewNotDataAdapter<T>(open val listener: IRecyclerViewCallback? = null) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    protected abstract fun empityHolder(parent: ViewGroup): RecyclerView.ViewHolder
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            empityType -> empityHolder(parent)
            loadingType -> LoadingHolder(parent)
            nullType -> NullHolder(parent)
