 ...
 * @since Apr 4, 2011
 */
class AutoResizeTextView : TextViewBarlowBold {
    ...
    fun resizeText(width: Int, height: Int) {
        ...
        if (addEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
            ...
            // Draw using a static layout
            val layout = StaticLayout(text, paint, width, Layout.Alignment.ALIGN_NORMAL, mSpacingMult, mSpacingAdd, false)
    ...
    private fun getTextHeight(source: CharSequence?, paint: TextPaint, width: Int, textSize: Float): Int {
        ...
        val layout = StaticLayout(source, paintCopy, width, Layout.Alignment.ALIGN_NORMAL, mSpacingMult, mSpacingAdd, true)
