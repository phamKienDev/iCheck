...
class ButtonLightBlueCorners4 : BaseButton {
    ...
    override fun onSetupDefault() {
        ...
        defaultEnableBackground = vn.icheck.android.ichecklibs.ColorManager.getPrimaryColor(context)
        defaultPressedBackground = vn.icheck.android.ichecklibs.ColorManager.getSecondaryColor(context)
