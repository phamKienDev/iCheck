...
class QAIncomingMessageViewHolder (view: View) : BaseViewHolder<ICQAInPost>(view) {
    ...
    override fun bind(obj: ICQAInPost) {
        ...
        ViewHelper.makeTextViewResizable(itemView.tvMessage,3, itemView.tvMessage.context.getString(R.string.xem_them),true, vn.icheck.android.ichecklibs.Constant.getSecondaryColorCode)
    }
