...
import kotlinx.android.synthetic.main.item_image_product_question.view.imgImageMess
...
class HorizontalImageSendAdapter(val listener: IHorizontalImageSendListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ImageHolder(view: View) : BaseViewHolder<File>(view) {
        override fun bind(obj: File) {
            ...
            itemView.imgCloseImage.setOnClickListener {
                listener.onClickDeleteImageSend(adapterPosition, listData.size)
            }
