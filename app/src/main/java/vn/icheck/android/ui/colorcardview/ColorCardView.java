package vn.icheck.android.ui.colorcardview;
...
public class ColorCardView extends FrameLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public boolean getUseCompatPadding() {
            return ColorCardView.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return ColorCardView.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            ColorCardView.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                ColorCardView.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                ColorCardView.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return ColorCardView.this;
        }
    };

    public ColorCardView(@NonNull Context context) {
        this(context, null);
    }

    public ColorCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public ColorCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
