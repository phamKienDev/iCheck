...
class ListInteractiveViewModel : ViewModel() {
    ...
    fun getFriendRequest(isLoadMore: Boolean = false) {
        ...
        interaction.getListNotification(null, 2, offset, APIConstants.LIMIT, object : ICNewApiListener<ICLayoutData<ICListResponse<ICNotification>>> {
