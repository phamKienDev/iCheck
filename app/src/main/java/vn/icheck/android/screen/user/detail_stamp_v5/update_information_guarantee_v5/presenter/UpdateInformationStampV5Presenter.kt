 ...
 */
class UpdateInformationStampV5Presenter(val view: IUpdateInformationStampV5View) : BaseActivityPresenter(view) {
...
//            updateInformationVerifiedPhone(name, phone, email, cityId!!, districtId!!,address,productCode)
    ...
    private fun updateInformationGuarantee(name: String, phone: String, email: String, city: String, district: String, address: String,midStore:Int) {
        ...
        interactor.onUpdateInformationStampV5(district,city,name,email,mIdStamp!!,midStore,address,phone,deviceId,object :ICApiListener<IC_RESP_UpdateCustomerGuaranteeV6>{
