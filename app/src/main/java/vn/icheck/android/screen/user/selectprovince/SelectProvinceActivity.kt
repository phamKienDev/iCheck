 ...
 */
class SelectProvinceActivity : BaseActivity<SelectProvincePresenter>(), SelectProvinceView {
    ...
    override val getPresenter: SelectProvincePresenter
        get() = SelectProvincePresenter(this)
