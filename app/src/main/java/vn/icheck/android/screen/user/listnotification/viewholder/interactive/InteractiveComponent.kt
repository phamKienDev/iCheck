...
import vn.icheck.android.screen.user.listnotification.interactive.ListInteractiveActivity
import vn.icheck.android.util.kotlin.ActivityUtils

class InteractiveComponent(parent: ViewGroup) : BaseViewHolder<MutableList<ICNotification>>(createView(parent.context)) {
    private val friendRequestAdapter = InteractiveAdapter()
            ...
            (getChildAt(0) as ViewGroup).apply {
                ...
                getChildAt(1).setOnClickListener {
                    ICheckApplication.currentActivity()?.let { activity ->
                        ActivityUtils.startActivity<ListInteractiveActivity>(activity)
                    }
                }
            }
            ...
            return LinearLayout(context).also { layoutParent ->
                ...
                layoutParent.addView(LinearLayout(context).also { layoutTitle ->
                    ...
                    layoutTitle.addView(ViewHelper.createText(context,
                        ...
                        it.setText(R.string.tuong_tac_moi)
                    })
