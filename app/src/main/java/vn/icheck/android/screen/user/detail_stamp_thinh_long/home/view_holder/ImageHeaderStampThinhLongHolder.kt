...
import kotlinx.android.synthetic.main.image_header_stamp_thinh_long.view.*
...
class ImageHeaderStampThinhLongHolder(parent: ViewGroup, private val headerImagelistener: SlideHeaderStampHoaPhatListener) : BaseViewHolder<ICBarcodeProductV1>(LayoutInflater.from(parent.context).inflate(R.layout.image_header_stamp_thinh_long, parent, false)), ItemClickListener<String> {
