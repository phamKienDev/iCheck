package vn.icheck.android.screen.user.selectprovincestamp.adapter
...
class SelectProvinceStampAdapter(val listener: SelectProvinceStampView) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private val listData = mutableListOf<CitiesItem>()
    private val listSearch = mutableListOf<CitiesItem>()
    ...
    fun setData(list: MutableList<CitiesItem>?) {
        errorMessage = ""
    ...
    fun addData(list: MutableList<CitiesItem>?) {
        errorMessage = ""
    ...
    private  class ViewHolder(view: View) : BaseViewHolder<CitiesItem>(view) {

        override fun bind(obj: CitiesItem) {
