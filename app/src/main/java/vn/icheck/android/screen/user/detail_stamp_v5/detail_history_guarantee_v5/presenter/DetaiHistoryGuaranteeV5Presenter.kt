package vn.icheck.android.screen.user.detail_stamp_v5.detail_history_guarantee_v5.presenter
 ...
 */
class DetaiHistoryGuaranteeV5Presenter(val view: IDetaiHistoryGuaranteeV5View) : BaseActivityPresenter(view) {
