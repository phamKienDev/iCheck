...
class SelectDistrictBottomSheet(private val cityId: Int?) : BottomSheetDialogFragment(), ISelectDistrictView {

    override fun getTheme(): Int = R.style.BaseBottomSheetDialog

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog = BottomSheetDialog(requireContext(), theme)

    private val presenter = SelectDistrictBottomSheetPresenter(this)
    private val adapter = SelectDistrictBottomSheetAdapter(this)
    private var disposable: Disposable? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val v = inflater.inflate(R.layout.bottom_sheet_dialog_select_district, container, false)
    ...
    override fun onSetListDistrict(list: MutableList<ICDistrict>) {
    ...
    override fun onItemClicked(item: ICDistrict) {
        dismiss()
        EventBus.getDefault().post(ICMessageEvent(ICMessageEvent.Type.SELECT_DISTRICT, item))
    }
