...
import vn.icheck.android.screen.user.detail_stamp_v6.more_business_v6.adapter.MoreProductVerifiedInBusinessV6Adapter
import vn.icheck.android.screen.user.detail_stamp_v6.more_business_v6.presenter.MoreBusinessV6Presenter
...
class MoreBusinessV6Activity : BaseActivityMVVM(), IMoreBusinessV6View {
        ...
        layoutPhone.setOnClickListener {
            if (tvPhone.text.toString() != getString(R.string.dang_cap_nhat)) {
                if (PermissionHelper.checkPermission(this, Manifest.permission.CALL_PHONE, requestPhone)) {
                    ContactUtils.callFast(this@MoreBusinessV6Activity,tvPhone.text.toString())
                }
            }
        }
    ...
    private fun initRecyclerViewMoreProduct() {
        adapterSuggestion = MoreProductVerifiedInBusinessV6Adapter(this)
    ...
    override fun onItemClick(item: ICObjectOtherProductV6) {
