...
//          Thong tin bao hanh
            ...
            obj.data?.stamp?.guarantee?.let {
                ...
                tvNoteGuarantee.text = if (it.note != null) {
                    Html.fromHtml("<font color=#434343>${rText(R.string.ghi_chu)}: </font>" + "<b>" + it.note + "</b>")
                } else {
                    Html.fromHtml("<font color=#434343>${rText(R.string.ghi_chu)}: </font>" + "<b>" + getString(R.string.dang_cap_nhat) + "</b>")
                }
            }
        } else {
