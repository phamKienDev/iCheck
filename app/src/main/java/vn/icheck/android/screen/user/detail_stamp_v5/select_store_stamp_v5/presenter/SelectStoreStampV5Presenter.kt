package vn.icheck.android.screen.user.detail_stamp_v5.select_store_stamp_v5.presenter
 ...
 */
class SelectStoreStampV5Presenter(val view: ISelectStoreStampV5View) : BaseActivityPresenter(view) {
