...
//    private fun getBusinessBanner(businessID: Long?, productID: Long?) {
//        if (businessID != null) {
//            bannerInteractor?.getAds("evs_banner", "eb_${businessID}", null, 6, object : ICApiListener<ICListResponse<ICAds>> {
//                override fun onSuccess(obj: ICListResponse<ICAds>) {
//                    if (obj.rows.isNotEmpty()) {
//                        bannerInteractor = null
//                        view.onGetBannerSuccess(obj.rows)
//                    } else {
//                        getProductBanner(productID)
//                    }
//                }
//
//                override fun onError(error: ICBaseResponse?) {
...
//    private fun getProductBanner(productID: Long?) {
//        if (productID != null) {
//            bannerInteractor?.getAds("evs_banner", "ep_${productID}", null, 6, object : ICApiListener<ICListResponse<ICAds>> {
//                override fun onSuccess(obj: ICListResponse<ICAds>) {
//                    bannerInteractor = null
//                    view.onGetBannerSuccess(obj.rows)
//                }
...
//    private fun getBusinessPopup(businessID: Long?, productID: Long?) {
//        if (businessID != null) {
//            popupInteractor?.getAds("evs_popup", "eb_${businessID}", 1, null, object : ICApiListener<ICListResponse<ICAds>> {
//                override fun onSuccess(obj: ICListResponse<ICAds>) {
//                    if (obj.rows.isNotEmpty()) {
//                        popupInteractor = null
//                        view.onGetPopupSuccess(obj.rows[0])
//                    } else {
//                        getProductPopup(productID)
//                    }
//                }
//
//                override fun onError(error: ICBaseResponse?) {
...
//    private fun getProductPopup(productID: Long?) {
//        if (productID != null) {
//            popupInteractor?.getAds("evs_popup", "ep_${productID}", 1, null, object : ICApiListener<ICListResponse<ICAds>> {
//                override fun onSuccess(obj: ICListResponse<ICAds>) {
//                    if (obj.rows.isNotEmpty()) {
//                        popupInteractor = null
//                        view.onGetPopupSuccess(obj.rows[0])
