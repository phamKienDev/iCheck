...
class ListOtherNotificationViewModel : ViewModel() {
    ...
    fun getOtherNotification(isLoadMore: Boolean = false) {
        ...
        interaction.getListNotification(null, 4, 0, 4, object : ICNewApiListener<ICLayoutData<ICListResponse<ICNotification>>> {
