package vn.icheck.android.screen.user.detail_stamp_v6.more_business_v6.view
 ...
 */
interface IMoreBusinessV6View : BaseActivityView {
    ...
    fun onItemClick(item: ICObjectOtherProductV6)
