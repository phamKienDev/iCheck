package vn.icheck.android.screen.user.home_page.my_gift_warehouse.open_reward_box.presenter
...
class OpenRewardBoxPresenter(val view: IOpenRewardBoxView) : BaseActivityPresenter(view) {
