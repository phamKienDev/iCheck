package vn.icheck.android.screen.user.detail_stamp_v5.more_business_v5.presenter
 ...
 */
class MoreBusinessV5Presenter(val view: IMoreBusinessV5View) : BaseActivityPresenter(view) {
