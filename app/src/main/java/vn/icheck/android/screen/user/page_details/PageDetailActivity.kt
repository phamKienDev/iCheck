...
//                    SocialChatActivity.createPageChat(this, pageID)
        ...
        tvExtra.setOnClickListener {
            ...
            if (phone.isNotEmpty()) {
                DialogHelper.showConfirm(this, ViewHelper.setPrimaryHtmlString(applicationContext.getString(R.string.ban_co_muon_goi_dien_thoai_den_x, Constant.formatPhone(phone))), null, rText(R.string.de_sau), rText(R.string.dong_y), null, null, true, object : ConfirmDialogListener {
