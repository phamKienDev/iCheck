...
//                    SocialChatActivity.createPageChat(this, pageID)
        ...
        tvExtra.setOnClickListener {
            ...
            if (phone.isNotEmpty()) {
                DialogHelper.showConfirm(this, applicationContext.getString(R.string.ban_co_muon_goi_dien_thoai_den_s, Constant.formatPhone(phone)), null, getString(R.string.de_sau), getString(R.string.dong_y), null, null, true, object : ConfirmDialogListener {
