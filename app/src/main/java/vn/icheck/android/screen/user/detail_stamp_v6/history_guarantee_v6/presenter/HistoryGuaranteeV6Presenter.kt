package vn.icheck.android.screen.user.detail_stamp_v6.history_guarantee_v6.presenter
 ...
 */
class HistoryGuaranteeV6Presenter(val view: IHistoryGuaranteeV6View) : BaseActivityPresenter(view) {
    ...
    private fun onGetHistoryGuarantee(qrm: String?) {
        ...
        interactor.getHistoryGuaranteeV6(qrm, object : ICApiListener<ICListHistoryGuaranteeV6> {
