package vn.icheck.android.screen.user.selectprovince.adapter
...
class SelectProvinceAdapter(val listener: SelectProvinceView) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private  class ViewHolder(view: View) : BaseViewHolder<ICProvince>(view) {
