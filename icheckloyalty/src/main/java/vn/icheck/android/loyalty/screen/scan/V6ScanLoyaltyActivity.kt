                    ...
                    DialogHelperGame.dialogAccumulatePointSuccess(this,
                            ...
                            object : IClickButtonDialog<Long> {
                                override fun onClickButtonData(obj: Long?) {
                                    //todo start giftshop
//                                        this@IcheckScanActivity.startActivity<GiftShopActivity, Long>(ConstantsLoyalty.ID, obj ?: -1)
                                }
        ...
        viewModel.onCustomer.observe(this, {
            ...
            if (type == 1) {
                DialogHelperGame.dialogCustomerError(this, R.drawable.ic_error_scan_game, it, "Liên hệ với ${SharedLoyaltyHelper(this).getString(ConstantsLoyalty.OWNER_NAME)} để biết thêm chi tiết", object : IClickButtonDialog<ICKNone> {
                    override fun onClickButtonData(obj: ICKNone?) {
                        onBackPressed()
                    }
                })
