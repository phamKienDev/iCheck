                ...
                if (!isLoadMore) {
                    if (obj.data?.rows.isNullOrEmpty()) {
                        setErrorEmpty(R.drawable.ic_point_loyalty_empty,
                            vn.icheck.android.ichecklibs.util.getString(R.string.ban_chua_co_lich_su_doi_qua),
                            vn.icheck.android.ichecklibs.util.getString(R.string.tham_gia_tich_diem_de_doi_qua_to_nao),
                ...
                if (!isLoadMore) {
                    if (obj.data?.rows.isNullOrEmpty()) {
                        setErrorEmpty(R.drawable.ic_error_emty_history_topup,
                            ...
                            vn.icheck.android.ichecklibs.util.getString(R.string.toi_cua_hang_qua_tang_de_doi_nhung_phan_qua_hap_dan_nhe),
                            vn.icheck.android.ichecklibs.util.getString(R.string.toi_cua_hang_qua_tang), R.drawable.bg_gradient_button_blue, R.color.white)
                    } else {
