...
class SelectDistrictAdapter(val listener: ISelectAddressListener<ICDistrict>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun addData(list: MutableList<ICDistrict>) {
        errorMessage = ""
    ...
    private class ViewHolder(parent: ViewGroup) : BaseViewHolder<ICDistrict>(R.layout.item_address, parent) {
