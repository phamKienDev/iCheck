...
object ImageHelper {
    ...
    val thumbSmallSize: String
        get() {
            return RStringUtils.rText(R.string.thumb_small_size)
        }

    val thumbMediumSize: String
        get() {
            return RStringUtils.rText(R.string.thumb_medium_size)
        }

    val thumbLargeSize: String
        get() {
            return RStringUtils.rText(R.string.thumb_large_size)
        }

    val smallSize: String
        get() {
            return RStringUtils.rText(R.string.small_size)
        }

    val mediumSize: String
        get() {
            return RStringUtils.rText(R.string.medium_size)
        }

    val largeSize: String
        get() {
            return RStringUtils.rText(R.string.large_size)
        }

    val originalSize: String
        get() {
            return RStringUtils.rText(R.string.original_size)
        }
